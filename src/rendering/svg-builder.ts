...
export class SVGBuilder {
  ...
  build(): string {
    ...
    if (this.responsive) {
      // For truly responsive SVGs, use CSS styling instead of fixed dimensions
      return `<svg viewBox="0 0 ${this.width} ${this.height}" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" style="width: 100%; height: 100%; max-width: 100%; max-height: 100%;">
      ${defsSection}
      ${this.elements.join('\n')}
    </svg>`;
    } else {
